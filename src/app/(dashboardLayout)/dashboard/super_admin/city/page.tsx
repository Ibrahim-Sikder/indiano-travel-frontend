...
import CreateCityModal from "./_components/CreateCityModal";
  ...
  return (
    <Box sx={{ width: "100%", padding: 2 }}>
      ...
      >
        <Button
          component={Link}
          href="/dashboard/super_admin/city/create"
          variant="contained"
          color="primary"
        >
          Create City
        </Button>
        <TextField size="small" label="Search City" variant="outlined" />
      </Stack>

      <CreateCityModal open={isModalOpen} setOpen={setIsModalOpen} />
